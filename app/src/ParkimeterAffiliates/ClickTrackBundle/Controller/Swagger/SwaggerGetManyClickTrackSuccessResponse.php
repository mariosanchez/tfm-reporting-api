...
namespace ParkimeterAffiliates\ClickTrackBundle\Controller\Swagger;

/**
 * @Swagger\Annotations\Definition(type="object")
 */
class SwaggerGetManyClickTrackSuccessResponse
{
    /**
     ...
     *     type="array",
     *     property="_embedded",
     *     @Swagger\Annotations\Items(ref="#/definitions/SwaggerGetClickTrackSuccessResponse")
     * )
     */
    private $embedded = [];
