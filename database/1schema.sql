...
INSERT INTO `affiliate_status` (`affiliate_status_id`, `name`) VALUES (0, 'disabled'), (1, 'enabled'), (2, 'unverified');
...
CREATE TABLE IF NOT EXISTS conversion_track (
...
CREATE TABLE IF NOT EXISTS cancellation_track (
...
CREATE TABLE IF NOT EXISTS click_track (
